package kr.co.infopub.chapter.s088_2;
...
public class BillboardfxController {
    ...
    void initialize() {
    	...
    	billobardTable.setOnMouseClicked(e ->{
        	if(billobardTable.getSelectionModel().getSelectedItem()!=null ){
        		...
        		webEngine.load("https://www.youtube.com/results?search_query="+toP(billboard.getArtist())); //artist
        	}
          }
        );
        //빌보드 차트 읽기
    ...
    public void getAllBillboard(){
		...
		lbbill.setText("Billboard Artist  "+rs);
    }
